...
import { getProjects, archiveProject as apiArchiveProject, deleteProject, batchDeleteProjects } from '../lib/workspace-api';
...
export const useProjectStore = create<ProjectStoreState>()((set, get) => ({
  ...
  fetchProjects: async (force = false) => {
    ...
    try {
      ...
      const projects: ProjectRecord[] = response.items.map((item) => ({
        id: item.id,
        name: item.name,
